package Test;
// absorm.abs:16:1: 
public class AbsDbOrmImpl_c extends abs.backend.java.lib.runtime.ABSObject implements abs.backend.java.lib.types.ABSClass, Test.AbsDbOrm_i {
    private static final java.lang.String[] __fieldNames = new java.lang.String[] {  };
    public final java.util.List<java.lang.String> getFieldNames() { return java.util.Arrays.asList(__fieldNames); }
    public AbsDbOrmImpl_c() {
    ...
    public final java.lang.String getClassName() { return "AbsDbOrmImpl"; }
    public static final <T extends AbsDbOrmImpl_c> T createNewCOG() { return (T)AbsDbOrmImpl_c.__ABS_createNewCOG(null, null); }
    public static final <T extends AbsDbOrmImpl_c> T __ABS_createNewCOG(abs.backend.java.lib.runtime.ABSObject __ABS_source, abs.backend.java.scheduling.UserSchedulingStrategy strategy) {
        final abs.backend.java.lib.runtime.ABSRuntime __ABS_runtime = abs.backend.java.lib.runtime.ABSRuntime.getCurrentRuntime();
        final abs.backend.java.lib.runtime.COG __ABS_cog = strategy == null ? __ABS_runtime.createCOG(AbsDbOrmImpl_c.class) : __ABS_runtime.createCOG(AbsDbOrmImpl_c.class, strategy);
        ...
        try {
            AbsDbOrmImpl_c __ABS_result = (AbsDbOrmImpl_c) __ABS_runtime.getForeignObject
            ("Test.AbsDbOrmImpl");
            if (__ABS_result == null) __ABS_result = new AbsDbOrmImpl_c();
            ;
    ...
    public static final <T extends AbsDbOrmImpl_c> T createNewObject() { return (T)AbsDbOrmImpl_c.__ABS_createNewObject(null); }
    public static final <T extends AbsDbOrmImpl_c> T __ABS_createNewObject(abs.backend.java.lib.runtime.ABSObject __ABS_source) {
        AbsDbOrmImpl_c __ABS_result = (AbsDbOrmImpl_c) abs.backend.java.lib.runtime.ABSRuntime.getCurrentRuntime().getForeignObject
        ("Test.AbsDbOrmImpl");
        if (__ABS_result == null) __ABS_result = new AbsDbOrmImpl_c();
    ...
    public final abs.backend.java.lib.runtime.ABSFut<ABS.StdLib.List<Test.Account_i>> async_findAllByAttributes(abs.backend.java.lib.types.ABSString className, abs.backend.java.lib.types.ABSString query) {
        return (abs.backend.java.lib.runtime.ABSFut)abs.backend.java.lib.runtime.ABSRuntime.getCurrentRuntime().asyncCall(new abs.backend.java.lib.runtime.AbstractAsyncCallRT<Test.AbsDbOrmImpl_c>(
            this,
