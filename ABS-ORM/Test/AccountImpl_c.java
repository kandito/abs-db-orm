...
public final class AccountImpl_c extends abs.backend.java.lib.runtime.ABSObject implements abs.backend.java.lib.types.ABSClass, Test.Account_i {
    ...
    public final abs.backend.java.lib.types.ABSUnit setFirstName(abs.backend.java.lib.types.ABSString firstName) {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",67);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",68);
    ...
    public final abs.backend.java.lib.types.ABSString getFirstName() {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",72);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",73);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().popStackFrame();
    ...
    public final abs.backend.java.lib.types.ABSUnit setLastName(abs.backend.java.lib.types.ABSString lastName) {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",77);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",78);
    ...
    public final abs.backend.java.lib.types.ABSString getLastName() {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",82);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",83);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().popStackFrame();
    ...
    public final abs.backend.java.lib.types.ABSUnit setbalance(abs.backend.java.lib.types.ABSRational balance) {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",87);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",88);
    ...
    public final abs.backend.java.lib.types.ABSRational getbalance() {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",92);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",93);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().popStackFrame();
    ...
    public final abs.backend.java.lib.types.ABSUnit setId(abs.backend.java.lib.types.ABSInteger id) {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",97);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",98);
    ...
    public final abs.backend.java.lib.types.ABSInteger getId() {
        ...
        if (__ABS_getRuntime().debuggingEnabled()) {
         ...
         {
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",102);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().nextStep("absorm.abs",103);
            if (__ABS_getRuntime().debuggingEnabled()) __ABS_getRuntime().getCurrentTask().popStackFrame();
