        ...
        return (new abs.backend.java.lib.expr.Case() {
            public abs.backend.java.lib.types.ABSBool of(final A e, final ABS.StdLib.Set<A> ss, final ABS.StdLib.Set<A> __ABS_value) {
                ...
                if (__ABS_binding2 != null) return new Object() {
                    public abs.backend.java.lib.types.ABSBool execute(final A x, final ABS.StdLib.Set<A> xs) { return x.gt(e).toBoolean() ? abs.backend.java.lib.types.ABSBool.FALSE : ABS.StdLib.contains_f.apply(xs, e); }
                }.execute((A) __ABS_binding2.getBinding(0),(ABS.StdLib.Set<A>) __ABS_binding2.getBinding(1));
                throw new abs.backend.java.lib.expr.UnmatchedCaseException("abslang.abs:70:3:  value " + __ABS_value + " did not match any pattern.");
            }
        }.of(e, ss, ss));
    }
}
