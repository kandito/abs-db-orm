            ...
            public ABS.StdLib.Set<A> of(final ABS.StdLib.Set<A> set1, final ABS.StdLib.Set<A> set2, final ABS.StdLib.Set<A> __ABS_value) {
                ...
                if (__ABS_binding1 != null) return new Object() {
                    public ABS.StdLib.Set<A> execute(final A e1, final ABS.StdLib.Set<A> ss1) { return new abs.backend.java.lib.expr.Case() {
                        public ABS.StdLib.Set<A> of(final A e1, final ABS.StdLib.Set<A> set1, final ABS.StdLib.Set<A> set2, final ABS.StdLib.Set<A> ss1, final ABS.StdLib.Set<A> __ABS_value) {
                            final abs.backend.java.lib.expr.PatternBinding __ABS_binding0 = new abs.backend.java.lib.expr.PatternConstructor(ABS.StdLib.Set_EmptySet.class).match(__ABS_value);
                            if (__ABS_binding0 != null) return new Object() {
                            ...
                            if (__ABS_binding2 != null) return new Object() {
                                public ABS.StdLib.Set<A> execute(final A e2, final ABS.StdLib.Set<A> ss2) { return e1.lt(e2).toBoolean() ? new ABS.StdLib.Set_Insert(e1, ABS.StdLib.union_f.apply(ss1, set2)) : new ABS.StdLib.Set_Insert(e2, ABS.StdLib.union_f.apply(set1, ss2)); }
                            }.execute((A) __ABS_binding2.getBinding(0),(ABS.StdLib.Set<A>) __ABS_binding2.getBinding(1));
                            throw new abs.backend.java.lib.expr.UnmatchedCaseException("abslang.abs:93:27:  value " + __ABS_value + " did not match any pattern.");
                        }
                    }.of(e1, set1, set2, ss1, set2); }
                }.execute((A) __ABS_binding1.getBinding(0),(ABS.StdLib.Set<A>) __ABS_binding1.getBinding(1));
                throw new abs.backend.java.lib.expr.UnmatchedCaseException("abslang.abs:91:4:  value " + __ABS_value + " did not match any pattern.");
            }
        }.of(set1, set2, set1));
    }
}
